...
public class ThreadTest extends Thread {
	// 日志工具
	final static Logger logger = Logger.getLogger(ThreadTest.class);
	...
	public static void main(String[] args) {
		Thread t1 = new ThreadTest("张三", 9);
		Thread t2 = new ThreadTest("李四", 9999);
	 ...
	 *            线程名称
	 */
	public ThreadTest(String name, int step) {
		super(name);
		this.step = step;
	}
